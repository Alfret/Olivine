...
//
static GLFWbool
isValidElementForJoystick(const _GLFWmapelement* e, const _GLFWjoystick* js)
{
...
//
static _GLFWmapping*
findValidMapping(const _GLFWjoystick* js)
{
...
//
static GLFWbool
parseMapping(_GLFWmapping* mapping, const char* string)
{
  const char* c = string;
  size_t i, length;
  struct
...
//
void
_glfwInputDrop(_GLFWwindow* window, int count, const char** paths)
{
                   ...
                   int hatCount)
{
  ...
  strncpy_s(js->guid, 33, guid, sizeof(js->guid) - 1);
...
GLFWAPI int
glfwGetInputMode(GLFWwindow* handle, int mode)
{
...
GLFWAPI void
glfwSetInputMode(GLFWwindow* handle, int mode, int value)
{
  _GLFWwindow* window = (_GLFWwindow*)handle;
  assert(window != NULL);
  ...
  if (mode == GLFW_CURSOR) {
    ...
    _glfwPlatformGetCursorPos(
      window, &window->virtualCursorPosX, &window->virtualCursorPosY);
...
GLFWAPI int
glfwGetKey(GLFWwindow* handle, int key)
{
  _GLFWwindow* window = (_GLFWwindow*)handle;
  assert(window != NULL);
...
GLFWAPI int
glfwGetMouseButton(GLFWwindow* handle, int button)
{
  _GLFWwindow* window = (_GLFWwindow*)handle;
  assert(window != NULL);
...
GLFWAPI void
glfwGetCursorPos(GLFWwindow* handle, double* xpos, double* ypos)
{
  _GLFWwindow* window = (_GLFWwindow*)handle;
  assert(window != NULL);
...
GLFWAPI void
glfwSetCursorPos(GLFWwindow* handle, double xpos, double ypos)
{
  _GLFWwindow* window = (_GLFWwindow*)handle;
  assert(window != NULL);
  ...
  if (xpos != xpos || xpos < -DBL_MAX || xpos > DBL_MAX || ypos != ypos ||
    ...
    _glfwInputError(
      GLFW_INVALID_VALUE, "Invalid cursor position %f %f", xpos, ypos);
    return;
  }
...
GLFWAPI void
glfwSetCursor(GLFWwindow* windowHandle, GLFWcursor* cursorHandle)
{
...
GLFWAPI GLFWdropfun
glfwSetDropCallback(GLFWwindow* handle, GLFWdropfun cbfun)
{
  _GLFWwindow* window = (_GLFWwindow*)handle;
  assert(window != NULL);
...
GLFWAPI void
glfwSetJoystickUserPointer(int jid, void* pointer)
{
  _GLFWjoystick* js;
...
GLFWAPI GLFWjoystickfun
glfwSetJoystickCallback(GLFWjoystickfun cbfun)
{
  _GLFW_REQUIRE_INIT_OR_RETURN(NULL);
...
GLFWAPI void
glfwSetClipboardString(GLFWwindow* handle, const char* string)
{
  assert(string != NULL);
...
GLFWAPI const char*
glfwGetClipboardString(GLFWwindow* handle)
{
  _GLFW_REQUIRE_INIT_OR_RETURN(NULL);
