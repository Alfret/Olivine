...
_glfwInputError(int code, const char* format, ...)
{
  ...
  if (format) {
    ...
    if (code == GLFW_NOT_INITIALIZED)
      strcpy_s(
        description, _GLFW_MESSAGE_SIZE, "The GLFW library is not initialized");
    else if (code == GLFW_NO_CURRENT_CONTEXT)
      strcpy_s(description, _GLFW_MESSAGE_SIZE, "There is no current context");
    else if (code == GLFW_INVALID_ENUM)
      strcpy_s(
        description, _GLFW_MESSAGE_SIZE, "Invalid argument for enum parameter");
      ...
      strcpy_s(
        description, _GLFW_MESSAGE_SIZE, "The requested API is unavailable");
      ...
      strcpy_s(
        description, _GLFW_MESSAGE_SIZE, "A platform-specific error occurred");
    else if (code == GLFW_FORMAT_UNAVAILABLE)
      strcpy_s(
        description, _GLFW_MESSAGE_SIZE, "The requested format is unavailable");
    else if (code == GLFW_NO_WINDOW_CONTEXT)
      strcpy_s(
        description, _GLFW_MESSAGE_SIZE, "The specified window has no context");
    else
